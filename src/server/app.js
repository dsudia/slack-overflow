...
rtm.on(RTM_EVENTS.MESSAGE, function(message) {
  ...
  if (text.includes('how') && text.includes('use') && text.includes('overflow') && text.includes('question')) {
    rtm.sendMessage(quesResponse, channel, function messageSent() {
      console.log ('Question response sent!');
    });
  } else if (text.includes('how') && text.includes('use') && text.includes('overflow') && text.includes('answer')) {
